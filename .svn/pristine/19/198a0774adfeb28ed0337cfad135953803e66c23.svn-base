...
<BODY>
	<FORM id=form1 name=form1
		...
		method="post"  onsubmit="return checkForm(['user.uid','visit_nexttime']);" >
		<!-- 隐藏域回显当前编辑的拜访记录id -->
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								<td>所属客户：</td>
								<td >
								<input type="hidden" name="customer.cusid" style="WIDTH: 180px" id="cusid" value="<s:property value="#saleVisit.customer.cusid" />" />
