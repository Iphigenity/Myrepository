										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													<TD>客户名称：</TD>
													<TD>
														<input type="hidden" name="customer.cusid" id="cust_id" value="${param['customer.cusid']}" />
											...
											<TBODY>
												...
												<TR
													...
													<TD>
														...
														&nbsp;&nbsp;
														<a href="javascript:void(0)" onclick="deleteConfirm('<s:property value="custName" />','${pageContext.request.contextPath }/CustomerAction_delete?cusid=<s:property value="cusid" />');" >删除</a>
													</TD>
												</TR>
												</s:iterator>
