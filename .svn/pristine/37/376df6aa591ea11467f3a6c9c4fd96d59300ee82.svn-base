											...
											<TBODY>
												<TR>
													...
													<TD>
														...
														style="WIDTH: 80px" maxLength=50 name="lkm_name" value="${param['name']}">
													</TD>
													<TD>客户名称：</TD>
													<TD>
														<input type="hidden" name="customer.cusid" id="cusid" value="${param['customer.cusid']}" />
														<INPUT class=textbox style="WIDTH: 80px" maxLength=50 name="custName"  id="custName" value="${param['custName']}" >
														<input type="button" value="选择客户" onclick="window.open('${pageContext.request.contextPath}/CustomerAction_list?choose=true','','width=600,height=300')" />
													</TD>
													<TD>
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD><s:property value="#linkMan.name" /></TD>
													<TD><s:property value="#linkMan.sex" /></TD>
													<TD><s:property value="" /></TD>
													<TD><s:property value="" /></TD>
													<TD>
													<a href="${pageContext.request.contextPath }/LinkManAction_Edit?lid=<s:property value="#linkMan.lid" />">修改</a>
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath }/linkmanServlet?method=delete&lkmId=${linkman.lid}">删除</a>
													</TD>
												</TR>
												</s:iterator>
